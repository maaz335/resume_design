...
class _resume_designState extends State<resume_design> {
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(fontSize: MediaQuery.of(context).size.height*0.013),
                          ),
                        ),
                      ),
                    ],
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        "    Education",
                        style: TextStyle(
                            fontSize:MediaQuery.of(context).size.height*0.014, fontWeight: FontWeight.bold),
                      ),
                    ],
                  ),
                  Row(
                    children: [
                      ...
                      Text(
                        "     $educaion\n\n\n",
                        style: TextStyle(fontSize: MediaQuery.of(context).size.height*0.014, color: Colors.white),
                      ),
                    ],
                  ),
                  Row(
  ...
  createPDF() async {
    ...
    page.graphics.drawImage(
        imageBitmap, Rect.fromLTWH((page.size.width - (imageSize.width / imageSize.height * page.size.height)) /100 , 0, page.size.width  ,page.size.height));//(page.size.width - (imageSize.width / imageSize.height * page.size.height)) /2  //imageSize.width / imageSize.height * page.size.height  //page.size.height
